...
class TestCampaign(BaseCase):
    ...
    def test_settings_btn(self, campaign_page):
        campaign_page.click(campaign_page.locators.SETTINGS_BTN)
        campaign_page.find_element(campaign_page.locators.SETTINGS_CONTEXT_MENU)

    def test_download_btn(self, campaign_page):
        campaign_page.click(campaign_page.locators.DOWNLOAD_BTN)
        campaign_page.find_element(campaign_page.locators.DOWNLOAD_CONTEXT_MENU)
