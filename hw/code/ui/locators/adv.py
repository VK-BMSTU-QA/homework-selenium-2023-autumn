...
class AdvLocators(BasePageLocators):
    ...
    GENERATION_TEXT_INPUTS = (By.XPATH, '//div[contains(@class, "AutogenModal_modalContent")]//textarea')
    GENERATE_BUTTON = (By.XPATH, '//div[contains(@class, "AutogenModal_modalContent")]//button')
    
    GENERATE_ERROR = (By.XPATH, '//div[contains(@class, "AutogenModal_modalContent")]//*[contains(text(), "Ошибка валидации текста: Недостаточно слов:")]')
    ...
    LOG_VARIANTS = (By.XPATH, '//*[@id="media-library-image"]//div[contains(@class, "ImageItems_active")]')

    TEXT_INPUTS = (By.XPATH, '//input[@type="text"]')
    AREA_INPUTS = (By.XPATH, '//textarea')
    
    COMPANY_NAME = (By.XPATH, '//*[contains(@class, "Sidebar")]//span[contains(text(),"Кампания")]')