...
class BasePageLocators:
    ...
    ELEMENT_WITH_CLASS = lambda self, element, class_name : (By.XPATH, f"//{element}[contains(@class, \"{class_name}\")]")
    ...
    CONTAINS_ANY_TEXT = lambda self, text : (By.XPATH, f"//*[contains(text(), '{text}')]")
